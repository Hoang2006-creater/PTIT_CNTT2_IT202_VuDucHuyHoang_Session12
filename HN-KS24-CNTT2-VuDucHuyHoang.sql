...
begin
    select s.studentid, s.fullname, e.courseid, e.score
    from enrollment e
...
-- gọi thủ tục cho môn database systems
call gettopscorestudent('c00001');

-- phần c
-- câu 6a: view_view_it_enrollment_db
...
-- câu 6b: procedure updatescore_it_db
delimiter $$
...
-- câu 6c: gọi thủ tục kiểm tra
set @newscore = 13;
call updatescore_it_db('s00001', @newscore);

-- hiển thị lại điểm mới
